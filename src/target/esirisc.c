...
static const struct {
	...
	{ REG_SP, "sp", REG_TYPE_DATA_PTR, "general" },
	{ REG_RA, "ra", REG_TYPE_INT, "general" },
	{ REG_R2, "r2", REG_TYPE_INT, "general" },
	{ REG_R3, "r3", REG_TYPE_INT, "general" },
	{ REG_R4, "r4", REG_TYPE_INT, "general" },
	{ REG_R5, "r5", REG_TYPE_INT, "general" },
	{ REG_R6, "r6", REG_TYPE_INT, "general" },
	{ REG_R7, "r7", REG_TYPE_INT, "general" },
	{ REG_R8, "r8", REG_TYPE_INT, "general" },
	{ REG_R9, "r9", REG_TYPE_INT, "general" },
	{ REG_R10, "r10", REG_TYPE_INT, "general" },
	{ REG_R11, "r11", REG_TYPE_INT, "general" },
	{ REG_R12, "r12", REG_TYPE_INT, "general" },
	{ REG_R13, "r13", REG_TYPE_INT, "general" },
	{ REG_R14, "r14", REG_TYPE_INT, "general" },
	{ REG_R15, "r15", REG_TYPE_INT, "general" },
	{ REG_R16, "r16", REG_TYPE_INT, "general" },
	{ REG_R17, "r17", REG_TYPE_INT, "general" },
	{ REG_R18, "r18", REG_TYPE_INT, "general" },
	{ REG_R19, "r19", REG_TYPE_INT, "general" },
	{ REG_R20, "r20", REG_TYPE_INT, "general" },
	{ REG_R21, "r21", REG_TYPE_INT, "general" },
	{ REG_R22, "r22", REG_TYPE_INT, "general" },
	{ REG_R23, "r23", REG_TYPE_INT, "general" },
	{ REG_R24, "r24", REG_TYPE_INT, "general" },
	{ REG_R25, "r25", REG_TYPE_INT, "general" },
	{ REG_R26, "r26", REG_TYPE_INT, "general" },
	{ REG_R27, "r27", REG_TYPE_INT, "general" },
	{ REG_R28, "r28", REG_TYPE_INT, "general" },
	{ REG_R29, "r29", REG_TYPE_INT, "general" },
	{ REG_R30, "r30", REG_TYPE_INT, "general" },
	{ REG_R31, "r31", REG_TYPE_INT, "general" },
};
...
static const struct {
	...
	{ REG_PC, CSR_THREAD, CSR_THREAD_EPC, "PC", REG_TYPE_CODE_PTR, "general" },	/*  PC -> EPC  */
	{ REG_CAS, CSR_THREAD, CSR_THREAD_ECAS, "CAS", REG_TYPE_INT, "general" },	/* CAS -> ECAS */
	{ REG_TC, CSR_THREAD, CSR_THREAD_ETC, "TC", REG_TYPE_INT, "system" },		/*  TC -> ETC  */
	{ REG_ETA, CSR_THREAD, CSR_THREAD_ETA, "ETA", REG_TYPE_INT, "system" },
	{ REG_ETC, CSR_THREAD, CSR_THREAD_ETC, "ETC", REG_TYPE_INT, "system" },
	{ REG_EPC, CSR_THREAD, CSR_THREAD_EPC, "EPC", REG_TYPE_CODE_PTR, "system" },
	{ REG_ECAS, CSR_THREAD, CSR_THREAD_ECAS, "ECAS", REG_TYPE_INT, "system" },
	{ REG_EID, CSR_THREAD, CSR_THREAD_EID, "EID", REG_TYPE_INT, "system" },
	{ REG_ED, CSR_THREAD, CSR_THREAD_ED, "ED", REG_TYPE_INT, "system" },
	{ REG_IP, CSR_INTERRUPT, CSR_INTERRUPT_IP, "IP", REG_TYPE_INT, "system"},
	{ REG_IM, CSR_INTERRUPT, CSR_INTERRUPT_IM, "IM", REG_TYPE_INT, "system"},
	{ REG_IS, CSR_INTERRUPT, CSR_INTERRUPT_IS, "IS", REG_TYPE_INT, "system"},
	{ REG_IT, CSR_INTERRUPT, CSR_INTERRUPT_IT, "IT", REG_TYPE_INT, "system"},
};
		...
		int *reg_list_size, enum target_register_class reg_class)
{
	...
	*reg_list = calloc(*reg_list_size, sizeof(struct reg *));
	...
	if (reg_class == REG_CLASS_ALL)
		...
		(*reg_list)[REG_PC] = esirisc->reg_cache->reg_list + REG_PC;
		(*reg_list)[REG_CAS] = esirisc->reg_cache->reg_list + REG_CAS;
	}
...
static struct reg_cache *esirisc_build_reg_cache(struct target *target)
{
	...
	esirisc->epc = reg_list + REG_EPC;
	esirisc->ecas = reg_list + REG_ECAS;
	esirisc->eid = reg_list + REG_EID;
	esirisc->ed = reg_list + REG_ED;
