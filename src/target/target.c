...
*  @returns:  JIM_ERR on error or JIM_OK on success and sets the result string to an array of ascii formatted numbers on success, with [<count>] number of elements.
*
