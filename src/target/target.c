...
uint32_t target_buffer_get_u64(struct target *target, const uint8_t *buffer)
{
...
static int target_read_buffer_default(struct target *target, target_ulong address, uint32_t size, uint8_t *buffer)
{
	int retval = ERROR_OK;
