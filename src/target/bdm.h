...
struct bdm_driver {
	/*
	   Hardware commands
	 */
	int (*background)(const struct bdm_driver *);
	int (*ack_enable)(const struct bdm_driver *);
	int_least16_t (*read_bd_byte)(const struct bdm_driver *, uint32_t);
	int_least32_t (*read_bd_word)(const struct bdm_driver *, uint32_t);
	int_least16_t (*read_byte)(const struct bdm_driver *, uint32_t);
	int_least32_t (*read_word)(const struct bdm_driver *, uint32_t);
	int (*write_bd_byte)(const struct bdm_driver *, uint32_t, uint8_t);
	int (*write_bd_word)(const struct bdm_driver *, uint32_t, uint16_t);
	int (*write_byte)(const struct bdm_driver *, uint32_t, uint8_t);
	int (*write_word)(const struct bdm_driver *, uint32_t, uint16_t);

	/*
	   Firmware commands
	 */
	int_least32_t (*read_next)(const struct bdm_driver *);
	int_least32_t (*read_pc)(const struct bdm_driver *);
	int_least32_t (*read_d)(const struct bdm_driver *);
	int_least32_t (*read_x)(const struct bdm_driver *);
	int_least32_t (*read_y)(const struct bdm_driver *);
	int_least32_t (*read_sp)(const struct bdm_driver *);

	int (*write_next)(const struct bdm_driver *, uint16_t);
	int (*write_pc)(const struct bdm_driver *, uint16_t);
	int (*write_d)(const struct bdm_driver *, uint16_t);
	int (*write_x)(const struct bdm_driver *, uint16_t);
	int (*write_y)(const struct bdm_driver *, uint16_t);
	int (*write_sp)(const struct bdm_driver *, uint16_t);

	int (*go)(const struct bdm_driver *);
	int (*go_until)(const struct bdm_driver *);
	int (*trace1)(const struct bdm_driver *);

	/*
	  Dongle firmware commands(not a part of BDM specification)
	 */
	int (*assert_reset)(const struct bdm_driver *);
	int (*deassert_reset)(const struct bdm_driver *);
	int (*assert_bknd)(const struct bdm_driver *);
	int (*deassert_bknd)(const struct bdm_driver *);


	int (*read_memory)(const struct bdm_driver *, uint32_t, uint32_t, uint32_t, uint8_t *);
	int (*write_memory)(const struct bdm_driver *, uint32_t, uint32_t, uint32_t, const uint8_t *);
};
