...
typedef struct mips64_common_s {
	...
	mips64_comparator_t *inst_break_list;
	mips64_comparator_t *data_break_list;
...
typedef struct mips64_core_reg_s {
	uint32_t num;
...
extern int mips64_arch_state(struct target *target);
extern int mips64_init_arch_info(struct target *target, mips64_common_t *mips64, struct jtag_tap *tap);
extern int mips64_restore_context(struct target *target);
extern int mips64_save_context(struct target *target);
extern struct reg_cache *mips64_build_reg_cache(struct target *target);
extern int mips64_run_algorithm(struct target *target, int num_mem_params, struct mem_param *mem_params,
	int num_reg_params, struct reg_param *reg_params,
	target_ulong entry_point, target_ulong exit_point,
	int timeout_ms, void *arch_info);
extern int mips64_configure_break_unit(struct target *target);
extern int mips64_enable_interrupts(struct target *target, int enable);
extern int mips64_examine(struct target *target);

extern int mips64_register_commands(struct command_context *cmd_ctx);
extern int mips64_invalidate_core_regs(struct target *target);
extern int mips64_get_gdb_reg_list(struct target *target,
