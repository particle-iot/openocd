...
struct mips64_5kc_common {
	uint32_t common_magic;
	bool is_pic32mx;
	struct mips64_common mips64;
};

static inline struct mips64_5kc_common *
target_to_5kc(struct target *target)
{
	return container_of(target->arch_info,
			struct mips64_5kc_common, mips64);
}

extern const struct command_registration mips64_5kc_command_handlers[];
