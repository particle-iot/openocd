...
struct adiv5_dap {
	...
	/**
	 * target_id for SWD in multidrop mode, otherwise DP_TARGETSEL_NONE
	 */
	uint32_t swd_target_id;
};
...
extern int adiv5_verify_config(struct target *target, struct adiv5_private_config *pc);
