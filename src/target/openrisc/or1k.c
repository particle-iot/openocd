		...
		uint32_t size, uint32_t count, uint8_t *buffer)
{
	...
	LOG_DEBUG("Read memory at 0x%08" PRIx32 ", size: %" PRId32 ", count: 0x%08" PRIx32, address, size, count);
		...
		uint32_t size, uint32_t count, const uint8_t *buffer)
{
	...
	LOG_DEBUG("Write memory at 0x%08" PRIx32 ", size: %" PRId32 ", count: 0x%08" PRIx32, address, size, count);
