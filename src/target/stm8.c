...
static const struct {
	...
	{  0,  "pc", REG_TYPE_ARCH_DEFINED, NULL, "org.gnu.gdb.stm8.core", 0 },
	{  1,  "a", REG_TYPE_INT8, NULL, "org.gnu.gdb.stm8.core", 0 },
	{  2,  "x", REG_TYPE_INT16, NULL, "org.gnu.gdb.stm8.core", 0 },
	{  3,  "y", REG_TYPE_INT16, NULL, "org.gnu.gdb.stm8.core", 0 },
	{  4,  "sp", REG_TYPE_INT16, NULL, "org.gnu.gdb.stm8.core", 0 },
	{  5,  "cc", REG_TYPE_INT8, NULL, "org.gnu.gdb.stm8.core", 0 },
};
...
#include "../../contrib/loaders/erase_check/stm8_erase_check.inc"
	...
	if (target_alloc_working_area(target, sizeof(stm8_erase_check_code), &erase_check_algorithm) != ERROR_OK)
		return ERROR_TARGET_RESOURCE_NOT_AVAILABLE;

	target_write_buffer(target, erase_check_algorithm->address, sizeof(stm8_erase_check_code), stm8_erase_check_code);
