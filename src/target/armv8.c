...
static int armv8_handle_l2x_cache_info_command(struct command_context *cmd_ctx,
	struct armv8_cache_common *armv8_cache)
{
...
static int armv8_l2x_cache_init(struct target *target, uint32_t base, uint32_t way)
{
