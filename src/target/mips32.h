...
#define MIPS32_ADDI(isa, tar, src, val)		(isa ? SWAP16(MMIPS32_ADDI(tar, src, val)) : \
									MIPS32_ISA_ADDI(tar, src, val))
#define MIPS32_ADDIU(isa, tar, src, val)	(isa ? SWAP16(MMIPS32_ADDIU(tar, src, val)) : \
									MIPS32_ISA_ADDIU(tar, src, val))
#define MIPS32_ADDU(isa, dst, src, tar)		(isa ? SWAP16(MMIPS32_ADDU(dst, src, tar)) : \
									MIPS32_ISA_ADDU(dst, src, tar))
#define MIPS32_AND(isa, dst, src, tar)		(isa ? SWAP16(MMIPS32_AND(dst, src, tar)) : \
									MIPS32_ISA_AND(dst, src, tar))
#define MIPS32_ANDI(isa, tar, src, val)		(isa ? SWAP16(MMIPS32_ANDI(tar, src, val)) : \
									MIPS32_ISA_ANDI(tar, src, val))
#define MIPS32_B(isa, off)			(isa ? SWAP16(MMIPS32_B(off)) : MIPS32_ISA_B(off))
#define MIPS32_BEQ(isa, src, tar, off)		(isa ? SWAP16(MMIPS32_BEQ(src, tar, off)) : \
									MIPS32_ISA_BEQ(src, tar, off))
#define MIPS32_BGTZ(isa, reg, off)		(isa ? SWAP16(MMIPS32_BGTZ(reg, off)) : MIPS32_ISA_BGTZ(reg, off))
#define MIPS32_BNE(isa, src, tar, off)		(isa ? SWAP16(MMIPS32_BNE(src, tar, off)) : \
									MIPS32_ISA_BNE(src, tar, off))
#define MIPS32_CACHE(isa, op, off, base)	(isa ? SWAP16(MMIPS32_CACHE(op, off, base)) : \
									MIPS32_ISA_CACHE(op, off, base))
#define MIPS32_J(isa, tar)			(isa ? SWAP16(MMIPS32_J(tar)) : MIPS32_ISA_J(tar))
#define MIPS32_JR(isa, reg)			(isa ? SWAP16(MMIPS32_JR(reg)) : MIPS32_ISA_JR(reg))
#define MIPS32_LB(isa, reg, off, base)		(isa ? SWAP16(MMIPS32_LB(reg, off, base)) : \
									MIPS32_ISA_LB(reg, off, base))
#define MIPS32_LBU(isa, reg, off, base)		(isa ? SWAP16(MMIPS32_LBU(reg, off, base)) : \
									MIPS32_ISA_LBU(reg, off, base))
#define MIPS32_LHU(isa, reg, off, base)		(isa ? SWAP16(MMIPS32_LHU(reg, off, base)) : \
									MIPS32_ISA_LHU(reg, off, base))
#define MIPS32_LW(isa, reg, off, base)		(isa ? SWAP16(MMIPS32_LW(reg, off, base)) : \
									MIPS32_ISA_LW(reg, off, base))
#define MIPS32_LUI(isa, reg, val)		(isa ? SWAP16(MMIPS32_LUI(reg, val)) : MIPS32_ISA_LUI(reg, val))
#define MIPS32_MFC0(isa, gpr, cpr, sel)		(isa ? SWAP16(MMIPS32_MFC0(gpr, cpr, sel)) : \
									MIPS32_ISA_MFC0(gpr, cpr, sel))
#define MIPS32_MTC0(isa, gpr, cpr, sel)		(isa ? SWAP16(MMIPS32_MTC0(gpr, cpr, sel)) : \
									MIPS32_ISA_MTC0(gpr, cpr, sel))
#define MIPS32_MFLO(isa, reg)			(isa ? SWAP16(MMIPS32_MFLO(reg)) : MIPS32_ISA_MFLO(reg))
#define MIPS32_MFHI(isa, reg)			(isa ? SWAP16(MMIPS32_MFHI(reg)) : MIPS32_ISA_MFHI(reg))
#define MIPS32_MTLO(isa, reg)			(isa ? SWAP16(MMIPS32_MTLO(reg)) : MIPS32_ISA_MTLO(reg))
#define MIPS32_MTHI(isa, reg)			(isa ? SWAP16(MMIPS32_MTHI(reg)) : MIPS32_ISA_MTHI(reg))
#define MIPS32_MOVN(isa, dst, src, tar)		(isa ? SWAP16(MMIPS32_MOVN(dst, src, tar)) : \
									MIPS32_ISA_MOVN(dst, src, tar))
#define MIPS32_ORI(isa, tar, src, val)		(isa ? SWAP16(MMIPS32_ORI(tar, src, val)) : \
									MIPS32_ISA_ORI(tar, src, val))
#define MIPS32_RDHWR(isa, tar, dst)		(isa ? SWAP16(MMIPS32_RDHWR(tar, dst)) : MIPS32_ISA_RDHWR(tar, dst))
#define MIPS32_SB(isa, reg, off, base)		(isa ? SWAP16(MMIPS32_SB(reg, off, base)) : \
									MIPS32_ISA_SB(reg, off, base))
#define MIPS32_SH(isa, reg, off, base)		(isa ? SWAP16(MMIPS32_SH(reg, off, base)) : \
									MIPS32_ISA_SH(reg, off, base))
#define MIPS32_SW(isa, reg, off, base)		(isa ? SWAP16(MMIPS32_SW(reg, off, base)) : \
									MIPS32_ISA_SW(reg, off, base))
#define MIPS32_SLL(isa, dst, src, sa)		(isa ? SWAP16(MMIPS32_SLL(dst, src, sa)) : \
									MIPS32_ISA_SLL(dst, src, sa))
#define MIPS32_SLTI(isa, tar, src, val)		(isa ? SWAP16(MMIPS32_SLTI(tar, src, val)) : \
									MIPS32_ISA_SLTI(tar, src, val))
#define MIPS32_SLTU(isa, dst, src, tar)		(isa ? SWAP16(MMIPS32_SLTU(dst, src, tar)) : \
									MIPS32_ISA_SLTU(dst, src, tar))
#define MIPS32_SRL(isa, reg, src, off)		(isa ? SWAP16(MMIPS32_SRL(reg, src, off)) : \
									MIPS32_ISA_SRL(reg, src, off))
#define MIPS32_SYNCI(isa, off, base)		(isa ? SWAP16(MMIPS32_SYNCI(off, base)) : MIPS32_ISA_SYNCI(off, base))
#define MIPS32_SYNC(isa)			(isa ? SWAP16(MMIPS32_SYNC) : MIPS32_ISA_SYNC)
#define MIPS32_XOR(isa, reg, val1, val2)	(isa ? SWAP16(MMIPS32_XOR(reg, val1, val2)) : \
									MIPS32_ISA_XOR(reg, val1, val2))
#define MIPS32_XORI(isa, tar, src, val)		(isa ? SWAP16(MMIPS32_XORI(tar, src, val)) : \
									MIPS32_ISA_XORI(tar, src, val))
#define MIPS32_SYNCI_STEP			0x1

/* ejtag specific instructions */
#define MIPS32_DRET(isa)			(isa ? SWAP16(MMIPS32_DRET) : MIPS32_ISA_DRET)
#define MIPS32_SDBBP(isa)			(isa ? SWAP16(MMIPS32_SDBBP) : MIPS32_ISA_SDBBP)
