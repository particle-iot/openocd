 ...
 * @returns ERROR_OK on success, negative error code on failure
 */
int bdm_cf26_read_memory(struct target *target, target_addr_t address,
 ...
 * @returns ERROR_OK on success, negative error code on failure
 */
int bdm_cf26_write_memory(struct target *target, target_addr_t address,
...
struct bdm_cf26_driver {
	...
	int (*read_memory)(const struct bdm_cf26_driver *, target_addr_t, uint32_t, uint32_t, uint8_t *);
	int (*write_memory)(const struct bdm_cf26_driver *, target_addr_t, uint32_t, uint32_t, const uint8_t *);
