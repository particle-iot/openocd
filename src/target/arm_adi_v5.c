...
static const struct {
	...
	{ ARM_ID, 0x4a1, "Cortex-A53 ROM v8", "(v8 ROM Table)", },
	{ ARM_ID, 0x4a2, "Cortex-A57 ROM",   "(ROM Table)", },
	{ ARM_ID, 0x4a3, "Cortex-A53 ROM v7", "(v7 ROM Table)", },
	...
	{ ARM_ID, 0x909, "CoreSight ATBR",   "(ATB Replicator)", },
	...
	{ ARM_ID, 0x932, "Cortex-M0+ MTB",   "(Embedded Trace)", },
