...
struct target {
	...
	target_ulong working_area;				/* working area (initialised RAM). Evaluated
	...
	target_ulong working_area_size;			/* size in bytes */
	target_ulong backup_working_area;		/* whether the content of the working area has to be preserved */
...
int target_read_buffer(struct target *target,
		target_ulong address, target_ulong size, uint8_t *buffer);
int target_checksum_memory(struct target *target,
		target_ulong address, target_ulong size, uint32_t *crc);
int target_blank_check_memory(struct target *target,
		target_ulong address, target_ulong size, target_ulong *blank);
...
int target_alloc_working_area(struct target *target,
		target_ulong size, struct working_area **area);
