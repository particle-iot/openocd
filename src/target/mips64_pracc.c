...
int mips64_pracc_exec(struct mips_ejtag *ejtag_info,
		      unsigned code_len, uint32_t *code,
...
int mips64_pracc_write_regs(struct mips_ejtag *ejtag_info, uint64_t *regs)
{
	uint32_t code[] = {
		...
		MIPS64_NOP /*MIPS64_DMTC0(2, MIPS64_C0_WATCHLO, 0)*/,
		MIPS64_LD(2, (MIPS64_NUM_CORE_REGS + 18) * 8, 1),
		MIPS64_NOP /*MIPS64_DMTC0(2, MIPS64_C0_WATCHLO, 1)*/,
		MIPS64_LD(2, (MIPS64_NUM_CORE_REGS + 19) * 8, 1),
		MIPS64_NOP /*MIPS64_MTC0(2, MIPS64_C0_WATCHHI, 0)*/,
		MIPS64_LD(2, (MIPS64_NUM_CORE_REGS + 20) * 8, 1),
		MIPS64_NOP /*MIPS64_MTC0(2, MIPS64_C0_WATCHHI, 1)*/,
