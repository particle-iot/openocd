...
#define QUALCOMM_IMPLEMENTER_ID 0x51
#define QUALCOMM_KRAIT_SUBPARTNUM 0x1

#define CORTEX_A_MIDR_PARTNUM_MASK 0x0000fff0
#define CORTEX_A_MIDR_PARTNUM_SHIFT 4
#define CORTEX_A_MIDR_QC_SUBPARTNUM_MASK 0x00000fc0
#define CORTEX_A_MIDR_QC_SUBPARTNUM_SHIFT 6
#define CORTEX_A_MIDR_IMPLEMENTER_MASK 0xff000000
#define CORTEX_A_MIDR_IMPLEMENTER_SHIFT 24
