...
typedef struct aarch64_system_register_field_t {
	const char *name;
	uint8_t msb;
	uint8_t lsb;
} aarch64_system_register_field_t;

typedef struct aarch64_system_register_t {
	...
	const char *op2;
	uint32_t encoding;
	aarch64_system_register_field_t fields[64];
} aarch64_system_register_t;

/* this table is auto-generated using:
 * tools/generate_arm_sysreg_table.py AArch64 inside the unzipped folder of
 * https://developer.arm.com/-/media/Files/ATG/Beta10/ARMv85A-SysReg-00bet10.tar.gz
 * */

static aarch64_system_register_t aarch64_system_registers[] = {
	{
		"OSDTRRX_EL1",
