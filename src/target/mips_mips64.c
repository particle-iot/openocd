...
static int mips_mips64_init_arch_info(struct target *target, mips_mips64_common_t *mips_mips64, struct jtag_tap *tap)
{
	mips64_common_t *mips64 = &mips_mips64->mips64_common;
...
{
	mips_mips64_common_t *mips_mips64 = calloc(1, sizeof(mips_mips64_common_t));
