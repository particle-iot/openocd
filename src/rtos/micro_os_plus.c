...
static const struct micro_os_plus_thread_state micro_os_plus_thread_states[] = { { 0, "Undefined" }, { 1, "Ready" },
...
static const char * const micro_os_plus_symbol_list[] = { "os::rtos::scheduler::top_threads_list_",
		"os::rtos::scheduler::current_thread_", "os::rtos::scheduler::is_started_",
		NULL };

const struct rtos_type micro_os_plus_rtos = { .name = "µOS++ IIIe",

.detect_rtos = micro_os_plus_detect_rtos, .create = micro_os_plus_create, .update_threads =
		micro_os_plus_update_threads, .get_thread_reg_list = micro_os_plus_get_thread_reg_list,
