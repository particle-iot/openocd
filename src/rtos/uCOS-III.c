...
static const char *uCOS_III_symbol_list[] = {
	"OSRunning",
	"OSTCBCurPtr",
	"OSTaskDbgListPtr",
	"OSTaskQty",
...
static const char *uCOS_III_thread_state_list[] = {
	"Ready",
	"Delay",
	"Pend",
	"Pend Timeout",
