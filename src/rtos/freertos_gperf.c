...
/* Command-line: gperf -L ANSI-C -t ../src/rtos/freertos.gperf  */
...
#line 2 "../src/rtos/freertos.gperf"
#include "freertos_gperf.h"
#line 17 "../src/rtos/freertos.gperf"
