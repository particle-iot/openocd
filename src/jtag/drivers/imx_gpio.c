...
/* Transition delay coefficients. Tuned for IMX6UL 528MHz. Adjusted experimentally for:
 *  10kHz, 100Khz, 500KHz. Speeds above 500Khz are impossible to reach via memory mapped
 *  method (at least for IMX6UL@528MHz) */
