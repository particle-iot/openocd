...
extern struct cmsis_dap_backend cmsis_dap_usb_backend;
#endif
#if BUILD_CMSIS_DAP_HID == 1
extern struct cmsis_dap_backend cmsis_dap_hid_backend;
#endif

static struct cmsis_dap_backend *cmsis_dap_backends[] =
{
#if BUILD_CMSIS_DAP_HID == 1
...
static char *cmsis_dap_serial = NULL;
...
{
	struct cmsis_dap_backend *backend = NULL;
	...
	dap->packet_buffer = malloc(PACKET_SIZE);
