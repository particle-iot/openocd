...
{
#if BUILD_FT2232_FTD2XX == 1
	return (ftdi_device == FT_DEVICE_2232H) || (ftdi_device == FT_DEVICE_4232H) || (ftdi_device == FT_DEVICE_232H);
#elif BUILD_FT2232_LIBFTDI == 1
	return (ftdi_device == TYPE_2232H || ftdi_device == TYPE_4232H || ftdi_device == TYPE_232H);
#endif
}
...
static int ft2232_init_ftd2xx(uint16_t vid, uint16_t pid, int more, int *try_more)
{
	...
	if (status != FT_OK) {
		...
		static const char *type_str[] = {
			"BM", "AM", "100AX", "UNKNOWN", "2232C", "232R", "2232H", "4232H", "232H", "X_SERIES"
		};
