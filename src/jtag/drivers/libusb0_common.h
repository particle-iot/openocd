...
#define jtag_libusb_claim_interface(dev, iface)		usb_claim_interface(dev, iface)
#define jtag_libusb_set_interface_alt_setting(dev, prev, alt)	usb_set_altinterface(dev, alt)
#define jtag_libusb_release_interface(dev, iface)	usb_release_interface(dev, iface)
