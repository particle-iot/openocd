...
#define jtag_libusb_claim_interface(dev, iface) libusb_claim_interface (dev, iface)
#define jtag_libusb_set_interface_alt_setting(dev, prev, alt) libusb_set_altinterface (dev, alt)
#define jtag_libusb_release_interface(dev, iface) libusb_release_interface (dev, iface)
