...
/*
 * NOTE: this driver actually supports only cfv234 (pemu fw0960)
 */
 ...
 * @returns 8-bit memory contents, negative error code failure
 */
int pemu_read_memory(const struct bdm_cf26_driver *bdm, target_addr_t address,
...
int pemu_write_memory(const struct bdm_cf26_driver *bdm, target_addr_t address,
