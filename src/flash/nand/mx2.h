...
#define		MXC_NF_V1_LAST_BUFFADDR		((MXC_NF_V1_SPARE_BUFFER3) + MXC_NF_SPARE_BUFFER_LEN - 2)
#define		MXC_NF_V2_LAST_BUFFADDR		((MXC_NF_V2_SPARE_BUFFER7) + MXC_NF_SPARE_BUFFER_LEN - 2)
