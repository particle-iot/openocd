...
#define NRF51_SOFT_DEVICE_DEF(id, dev, hw, maddr, ver) \
{                                                      \
.fwid     = (id),                                      \
.device   = dev,                                       \
.hardware = hw,                                        \
...
static const struct nrf51_soft_device_spec nrf51_known_soft_devices_table[] = {
	/* SoftDevice S110 */
	NRF51_SOFT_DEVICE_DEF(0x0001, "S110", "nRF51822", "0x0000300C", "0.6.0.alpha2"),
	NRF51_SOFT_DEVICE_DEF(0x0022, "S110", "nRF51822", "0x0000300C", "1.0.0.alpha6"),
	NRF51_SOFT_DEVICE_DEF(0x0025, "S110", "nRF51822", "0x0000300C", "2.0.0.alpha1"),
	NRF51_SOFT_DEVICE_DEF(0x0027, "S110", "nRF51822", "0x0000300C", "3.0.0-beta1"),
	NRF51_SOFT_DEVICE_DEF(0x002A, "S110", "nRF51822", "0x0000300C", "4.0.0-2.beta"),
	NRF51_SOFT_DEVICE_DEF(0x002C, "S110", "nRF51822", "0x0000300C", "5.0.0"),
	NRF51_SOFT_DEVICE_DEF(0x002E, "S110", "nRF51822", "0x0000300C", "5.1.0"),
	NRF51_SOFT_DEVICE_DEF(0x0032, "S110", "nRF51822", "0x0000300C", "5.2.0"),
	NRF51_SOFT_DEVICE_DEF(0x0035, "S110", "nRF51822", "0x10001010", "6.2.1"),
	NRF51_SOFT_DEVICE_DEF(0x0042, "S110", "nRF51822", "0x0000300C", "6.0.0-1.alpha"),
	NRF51_SOFT_DEVICE_DEF(0x0043, "S110", "nRF51822", "0x10001010", "5.2.1"),
	NRF51_SOFT_DEVICE_DEF(0x0049, "S110", "nRF51822", "0x10001010", "6.0.0"),
	NRF51_SOFT_DEVICE_DEF(0x004F, "S110", "nRF51822", "0x0000300C", "7.0.0"),
	NRF51_SOFT_DEVICE_DEF(0x005A, "S110", "nRF51822", "0x0000300C", "7.1.0"),
	NRF51_SOFT_DEVICE_DEF(0x0063, "S110", "nRF51822", "0x0000300C", "7.3.0"),
	NRF51_SOFT_DEVICE_DEF(0x0064, "S110", "nRF51822", "0x0000300C", "8.0.0"),
	/* SoftDevice S120 */
	NRF51_SOFT_DEVICE_DEF(0x002D, "S120", "nRF51822", "0x0000300C", "0.5.0-1.alpha"),
	NRF51_SOFT_DEVICE_DEF(0x0031, "S120", "nRF51822", "0x0000300C", "0.6.0-3.alpha"),
	NRF51_SOFT_DEVICE_DEF(0x0033, "S120", "nRF51822", "0x0000300C", "3xlink proto"),
	NRF51_SOFT_DEVICE_DEF(0x0055, "S120", "nRF51822", "0x0000300C", "1.0.0"),
	NRF51_SOFT_DEVICE_DEF(0x0058, "S120", "nRF51822", "0x0000300C", "1.0.1"),
	NRF51_SOFT_DEVICE_DEF(0x005B, "S120", "nRF51822", "0x0000300C", "2.0.0-1.alpha"),
	NRF51_SOFT_DEVICE_DEF(0x0060, "S120", "nRF51822", "0x0000300C", "2.0.0"),
	NRF51_SOFT_DEVICE_DEF(0x006B, "S120", "nRF51822", "0x0000300C", "2.1.0"),
	/* SoftDevice S130 */
	NRF51_SOFT_DEVICE_DEF(0x005E, "S130", "nRF51822", "0x0000300C", "0.9.0-1.alpha"),
	NRF51_SOFT_DEVICE_DEF(0x0066, "S130", "nRF51822", "0x0000300C", "1.0.0-3.alpha"),
	NRF51_SOFT_DEVICE_DEF(0x0067, "S130", "nRF51822", "0x0000300C", "1.0.0"),
	NRF51_SOFT_DEVICE_DEF(0x0080, "S130", "nRF51822", "0x0000300C", "2.0.0"),
	NRF51_SOFT_DEVICE_DEF(0x0087, "S130", "nRF51822", "0x0000300C", "2.0.1"),
	/* SoftDevice S132 */
	NRF51_SOFT_DEVICE_DEF(0x006D, "S132", "nRF51822", "?", "1.0.0-3.alpha"),
	NRF51_SOFT_DEVICE_DEF(0x0074, "S132", "nRF51822", "?", "2.0.0-4.alpha"),
	NRF51_SOFT_DEVICE_DEF(0x0079, "S132", "nRF51822", "0x0000300C", "2.0.0-7.alpha"),
	NRF51_SOFT_DEVICE_DEF(0x0081, "S132", "nRF51822", "0x0000300C", "2.0.0"),
	NRF51_SOFT_DEVICE_DEF(0x0088, "S132", "nRF51822", "0x0000300C", "2.0.1"),
	/* SoftDevice S210 */
	NRF51_SOFT_DEVICE_DEF(0x0001, "S210", "nRF51422", "0x0000300C", "1.0.1.alpha"),
	NRF51_SOFT_DEVICE_DEF(0x0024, "S210", "nRF51422", "0x0000300C", "1.2.0.alpha"),
	NRF51_SOFT_DEVICE_DEF(0x0028, "S210", "nRF51422", "0x0000300C", "2.0.0"),
	NRF51_SOFT_DEVICE_DEF(0x003E, "S210", "nRF51422", "0x0000300C", "3.0.0-1.beta"),
	NRF51_SOFT_DEVICE_DEF(0x004B, "S210", "nRF51422", "0x10001010", "3.0.0"),
	NRF51_SOFT_DEVICE_DEF(0x0057, "S210", "nRF51422", "0x0000300C", "4.0.0"),
	/* SoftDevice S212 */
	NRF51_SOFT_DEVICE_DEF(0x007F, "S212", "nRF51822", "0x0000300C", "0.6.0.alpha"),
	NRF51_SOFT_DEVICE_DEF(0x0083, "S212", "nRF51822", "0x0000300C", "0.9.1.alpha"),
	/* SoftDevice S310 */
	NRF51_SOFT_DEVICE_DEF(0x002F, "S310", "nRF51922", "0x0000300C", "0.1.0-3.alpha"),
	NRF51_SOFT_DEVICE_DEF(0x0030, "S310", "nRF51922", "0x0000300C", "0.1.0-4.alpha"),
	NRF51_SOFT_DEVICE_DEF(0x0044, "S310", "nRF51922", "0x0000300C", "0.2.0-1.beta"),
	NRF51_SOFT_DEVICE_DEF(0x004D, "S310", "nRF51922", "0x10001010", "1.0.0"),
	NRF51_SOFT_DEVICE_DEF(0x005D, "S310", "nRF51922", "0x0000300C", "2.0.0/2.0.1"),
	NRF51_SOFT_DEVICE_DEF(0x0065, "S310", "nRF51922", "0x0000300C", "3.0.0"),
	/* SoftDevice S332 */
	NRF51_SOFT_DEVICE_DEF(0x007E, "S332", "nRF51822", "0x0000300C", "0.6.0.alpha"),
	NRF51_SOFT_DEVICE_DEF(0x0082, "S332", "nRF51822", "0x0000300C", "0.9.1.alpha"),
	/* SoftDevice MEFW */
	NRF51_SOFT_DEVICE_DEF(0x0023, "MEFW", "nRF51822", "0x0000300C", "0.7.2"),
	NRF51_SOFT_DEVICE_DEF(0x0026, "MEFW", "nRF51822", "0x0000300C", "0.8.0"),
	/* Development */
	NRF51_SOFT_DEVICE_DEF(0xFFFE, "Development", "nRF5x", "?", "any"),
};
...
static int nrf51_probe(struct flash_bank *bank)
{
	...
	if (bank->base == NRF51_FLASH_BASE) {
		...
		if (spec && bank->size / 1024 != spec->flash_size_kb)
			LOG_WARNING("Chip's reported Flash capacity size %"PRIu32"kB does not match expected size %"PRIu32"kB",
				(bank->size / 1024), spec->flash_size_kb);
...
static struct nrf51_addr_desc nrf51_ficr_v2[] = {
	...
	{ .address = NRF51_FICR_DEVICEADDR0	},
	{ .address = NRF51_FICR_DEVICEADDR1	},
	{ .address = NRF51_FICR_INFO_PART	}, /* from pos 23 new regs */
...
static int nrf51_info(struct flash_bank *bank, char *buf, int buf_size)
{
	...
	uint32_t fwid = nrf51_uicr[3].value & 0xFFFF;
	const struct nrf51_soft_device_spec *soft_spec = NULL;
	const char *soft_device = "unknown";
	const char *soft_device_version = "unknown";
	for (size_t i = 0; i < ARRAY_SIZE(nrf51_known_soft_devices_table); i++)
		if (fwid == nrf51_known_soft_devices_table[i].fwid) {
			soft_spec = &nrf51_known_soft_devices_table[i];
			break;
		}
	if (soft_spec != NULL) {
		soft_device = soft_spec->device;
		soft_device_version = soft_spec->version;
	}
	...
	snprintf(buf, buf_size,
		...
		"firmware id: 0x%04"PRIx32" device-version: %s-%s\n",
		nrf51_ficr[0].value,
		...
		nrf51_uicr[3].value & 0xFFFF, soft_device, soft_device_version);
