...
/* MSP432 device types */
#define MSP432P4_NO_TYPE   0 /* Device type not determined yet */
#define MSP432P401R_DEPR   1 /* Early MSP432P401R offerings, now deprecated */
#define MSP432P401R        2 /* MSP432P401R device, revision C or higher */
#define MSP432P4111        3 /* MSP432P4111 device, revision A or higher */
#define MSP432P401R_GUESS  4 /* Assuming it's an MSP432P401R device */
...
/* Flash helper algorithm for MSP432P401R */
const uint8_t msp432p401r_algo[] = {
