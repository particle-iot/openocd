...
static void sfcdrv_set_cmd_buf(struct uwp5661_flash_bank *uwp5661_info, struct target *target,
				enum cmd_buf_index index, uint32_t value)
{
...
static void sfcdrv_set_type_inf_buf(struct uwp5661_flash_bank *uwp5661_info, struct target *target,
			enum cmd_buf_index index, enum bit_mode bitmode, enum byte_num bytenum, enum cmd_mode cmdmode,
			enum send_mode sendmode)
{
...
static enum byte_num spi_flash_addr(uint32_t *addr, uint8_t support_4addr)
{
	uint8_t cmd[4] = {0};
...
static int spiflash_cmd_sector_erase(struct uwp5661_flash_bank *uwp5661_info, struct target *target, uint32_t offset)
{
	...
	enum byte_num addr_byte_num = spi_flash_addr(&addr, uwp5661_info->flash.support_4addr);
