...
static void qspi_set_lut(struct flash_bank *bank)
{
	...
	qspi_set_lut_sequence(bank, SEQID_FAST_READ,
		OPRND0(QSPI_CMD_FAST_READ_4B) | PAD0(LUT_PAD1) | INSTR0(LUT_CMD) | OPRND1(ADDR32BIT) | PAD1(LUT_PAD1) | INSTR1(LUT_ADDR),
		OPRND0(8) | PAD0(LUT_PAD1) | INSTR0(LUT_DUMMY) | OPRND1(RX_BUFFER_SIZE) | PAD1(LUT_PAD1) | INSTR1(LUT_READ),
		0, 0);
	/* Read Status */
	qspi_set_lut_sequence(bank, SEQID_RDSR,
		OPRND0(QSPI_CMD_RDSR) | PAD0(LUT_PAD1) | INSTR0(LUT_CMD) | OPRND1(1) | PAD1(LUT_PAD1) | INSTR1(LUT_READ),
		0, 0, 0);
	/* Erase a sector */
	qspi_set_lut_sequence(bank, SEQID_SE,
		OPRND0(QSPI_CMD_SE_4B) | PAD0(LUT_PAD1) | INSTR0(LUT_CMD) | OPRND1(ADDR32BIT) | PAD1(LUT_PAD1) | INSTR1(LUT_ADDR),
		0, 0, 0);
	...
	qspi_set_lut_sequence(bank, SEQID_PP,
		OPRND0(QSPI_CMD_PP_4B) | PAD0(LUT_PAD1) | INSTR0(LUT_CMD) | OPRND1(ADDR32BIT) | PAD1(LUT_PAD1) | INSTR1(LUT_ADDR),
		OPRND0(TX_BUFFER_SIZE) | PAD0(LUT_PAD1) | INSTR0(LUT_WRITE), 0, 0);
	/* Read JEDEC ID */
	qspi_set_lut_sequence(bank, SEQID_RDID,
		OPRND0(QSPI_CMD_RDID) | PAD0(LUT_PAD1) | INSTR0(LUT_CMD) | OPRND1(8) | PAD1(LUT_PAD1) | INSTR1(LUT_READ),
		0, 0, 0);
	/* sub sector 4K erase */
	qspi_set_lut_sequence(bank, SEQID_BE_4K,
		OPRND0(QSPI_CMD_BE_4K) | PAD0(LUT_PAD1) | INSTR0(LUT_CMD) | OPRND1(ADDR24BIT) | PAD1(LUT_PAD1) | INSTR1(LUT_ADDR),
		0, 0, 0);
	/* read any device register */
	qspi_set_lut_sequence(bank, SEQID_RDAR,
		OPRND0(QSPI_CMD_RDAR) | PAD0(LUT_PAD1) | INSTR0(LUT_CMD) | OPRND1(ADDR24BIT) | PAD1(LUT_PAD1) | INSTR1(LUT_ADDR),
		OPRND0(8) | PAD0(LUT_PAD1) | INSTR0(LUT_DUMMY) | OPRND1(1) | PAD1(LUT_PAD1) | INSTR1(LUT_READ),
		0, 0);
	/* write any device register */
	qspi_set_lut_sequence(bank, SEQID_WRAR,
		OPRND0(QSPI_CMD_WRAR) | PAD0(LUT_PAD1) | INSTR0(LUT_CMD) | OPRND1(ADDR24BIT) | PAD1(LUT_PAD1) | INSTR1(LUT_ADDR),
...
static void qspi_op_rdid(struct flash_bank *bank, uint32_t *rxbuf, uint32_t len)
{
	...
	/* Reconfigure MCR */
	qspi_write32(bank, QSPI_MCR, QSPI_MCR_CLR_RXF_MASK | QSPI_MCR_CLR_TXF_MASK | QSPI_MCR_RESERVED_MASK | QSPI_MCR_END_CFD_LE);
	/* USE IPS */
