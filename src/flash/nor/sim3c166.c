...
#define SIM3C166_FLASH_KEYR	0x40008004
#define SIM3C166_FLASH_OPTKEYR	0x40008008
#define SIM3C166_FLASH_SR	0x4000800C
#define SIM3C166_FLASH_CR		0x40008010
#define SIM3C166_FLASH_AR		0x40008014
#define SIM3C166_FLASH_OBR		0x4000801C
#define SIM3C166_FLASH_WRPR	0x40008020

#define SIM3C166_FPEC_CLK		0x4000402c
...
static inline int sim3c166_get_flash_status(struct flash_bank *bank, uint32_t *status)
{
	...
	return target_read_u32(target, 0x4002e000, status);
}
...
static int sim3c166_erase_options(struct flash_bank *bank)
{
	...
	int retval = target_write_u32(target, SIM3C166_FLASH_KEYR, KEY1);
	if (retval != ERROR_OK)
		return retval;

	retval = target_write_u32(target, SIM3C166_FLASH_KEYR, KEY2);
	if (retval != ERROR_OK)
		return retval;

	/* unlock option flash registers */
	retval = target_write_u32(target, SIM3C166_FLASH_OPTKEYR, KEY1);
	if (retval != ERROR_OK)
		return retval;
	retval = target_write_u32(target, SIM3C166_FLASH_OPTKEYR, KEY2);
	if (retval != ERROR_OK)
		return retval;
...
static int sim3c166_erase(struct flash_bank *bank, int first, int last)
{
	...
	/* unlock flash registers */
	int retval = target_write_u32(target, 0x4002e000, 0x00040720);
	if (retval != ERROR_OK)
		return retval;
	retval = target_write_u8(target, 0x4002e0c0, 0xa5);
	if (retval != ERROR_OK)
		return retval;
	retval = target_write_u8(target, 0x4002e0c0, 0xf2);
	if (retval != ERROR_OK)
		return retval;
...
static int sim3c166_write(struct flash_bank *bank, uint8_t *buffer,
		uint32_t offset, uint32_t count)
{
	...
	/* unlock flash registers */
	retval = target_write_u32(target, 0x4002e0a0, 0x00000000);
	if (retval != ERROR_OK)
		return retval;
	retval = target_write_u32(target, 0x4002e000, 0x00000720);
	if (retval != ERROR_OK)
		return retval;
	retval = target_write_u8(target, 0x4002e0c0, 0xa5);
	if (retval != ERROR_OK)
...
static int sim3c166_probe(struct flash_bank *bank)
{
	...
	/* Enable FPEC CLK */
	int retval = target_write_u32(target, 0x4002d020, 0x40000002);
	if (retval != ERROR_OK)
		return retval;
...
static int get_sim3c166_info(struct flash_bank *bank, char *buf, int buf_size)
{
	int printed;
	printed = snprintf(buf, buf_size, "sim3c166\n");
	buf += printed;
	buf_size -= printed;
	return ERROR_OK;
}
