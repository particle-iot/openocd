...
#define QSPI_1LINE_MODE		0x01000500U		/* 1 line for address, data */
#define QSPI_2LINE_MODE		0x02000A00U		/* 2 lines for address, data */
...
#define QSPI_ADDR1			(0x0U<<QSPI_ADSIZE_POS)	/* 1 byte address */
#define QSPI_ADDR2			(0x1U<<QSPI_ADSIZE_POS)	/* 2 byte address */
#define QSPI_ADDR3			(0x2U<<QSPI_ADSIZE_POS)	/* 3 byte address */
