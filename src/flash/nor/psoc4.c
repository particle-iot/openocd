...
const struct psoc4_chip_details psoc4_devices[] = {
	/* 4000 series */
	{ 0x0A40, "CY8C4013SXI-400", "SOIC-8",    .flash_size_in_kb = 8 },
	{ 0x0A41, "CY8C4013SXI-410", "SOIC-8",    .flash_size_in_kb = 8 },
	{ 0x0A42, "CY8C4013SXI-411", "SOIC-16",   .flash_size_in_kb = 8 },
	{ 0x0A43, "CY8C4014SXI-411", "SOIC-16",   .flash_size_in_kb = 16 },
	{ 0x0A44, "CY8C4014SXI-421", "SOIC-16",   .flash_size_in_kb = 16 },
	{ 0x0A46, "CY8C4014LQI-421", "QFN-16",    .flash_size_in_kb = 16 },
	{ 0x0A47, "CY8C4014LQI-412", "QFN-24",    .flash_size_in_kb = 16 },
	{ 0x0A48, "CY8C4014LQI-422", "QFN-24",    .flash_size_in_kb = 16 },
	{ 0x0A53, "CY8C4014SXI-420", "SOIC-8",    .flash_size_in_kb = 16 },
	{ 0x0A54, "CY8C4014PVI-412", "SSOP-28",   .flash_size_in_kb = 16 },
	{ 0x0A55, "CY8C4014PVI-422", "SSOP-28",   .flash_size_in_kb = 16 },
	{ 0x0A63, "CY8C4014SXS-421", "SOIC-16",   .flash_size_in_kb = 16 },
	{ 0x0A69, "CY8C4014LQS-422", "QFN-24",    .flash_size_in_kb = 16 },

	/* 4000M series */
	{ 0x1100, "CY8C4125AZI-M433", "TQFP-48",  .flash_size_in_kb = 32 },
	{ 0x1101, "CY8C4125AZI-M443", "TQFP-48",  .flash_size_in_kb = 32 },
	{ 0x1102, "CY8C4125AZI-M445", "TQFP-64",  .flash_size_in_kb = 32 },
	{ 0x1103, "CY8C4125LTI-M445", "QFN-68",   .flash_size_in_kb = 32 },
	{ 0x1104, "CY8C4125AXI-M445", "TQFP-64",  .flash_size_in_kb = 32 },
	{ 0x1105, "CY8C4126AZI-M443", "TQFP-48",  .flash_size_in_kb = 64 },
	{ 0x1106, "CY8C4126AZI-M445", "TQFP-48",  .flash_size_in_kb = 64 },
	{ 0x1107, "CY8C4126AZI-M475", "TQFP-48",  .flash_size_in_kb = 64 },
	{ 0x1108, "CY8C4126LTI-M445", "QFN-68",   .flash_size_in_kb = 64 },
	{ 0x1109, "CY8C4126LTI-M475", "QFN-68",   .flash_size_in_kb = 64 },
	{ 0x110A, "CY8C4126AXI-M445", "TQFP-64",  .flash_size_in_kb = 64 },
	{ 0x110B, "CY8C4127LTI-M475", "QFN-68",   .flash_size_in_kb = 128 },
	{ 0x110C, "CY8C4127AZI-M475", "TQFP-64",  .flash_size_in_kb = 128 },
	{ 0x110D, "CY8C4127AZI-M485", "TQFP-64",  .flash_size_in_kb = 128 },
	{ 0x110E, "CY8C4127AXI-M485", "TQFP-64",  .flash_size_in_kb = 128 },

	/* 4000S series */
	{ 0x1900, "CY8C4045LQI-S412", "QFN-32",   .flash_size_in_kb = 32 },
	{ 0x1901, "CY8C4045AZI-S413", "TQFP-48",  .flash_size_in_kb = 32 },
	{ 0x1902, "CY8C4045FNI-S412", "WLCSP-25", .flash_size_in_kb = 32 },
	{ 0x1903, "CY8C4024LQI-S401", "QFN-24",   .flash_size_in_kb = 16 },
	{ 0x1904, "CY8C4024LQI-S411", "QFN-24",   .flash_size_in_kb = 16 },
	{ 0x1905, "CY8C4025LQI-S401", "QFN-24",   .flash_size_in_kb = 32 },
	{ 0x1906, "CY8C4025LQI-S411", "QFN-24",   .flash_size_in_kb = 32 },
	{ 0x1907, "CY8C4045LQI-S411", "QFN-24",   .flash_size_in_kb = 32 },
	{ 0x1908, "CY8C4024LQI-S402", "QFN-32",   .flash_size_in_kb = 16 },
	{ 0x1909, "CY8C4024LQI-S412", "QFN-32",   .flash_size_in_kb = 16 },
	{ 0x190A, "CY8C4025LQI-S402", "QFN-32",   .flash_size_in_kb = 32 },
	{ 0x190B, "CY8C4025LQI-S412", "QFN-32",   .flash_size_in_kb = 32 },
	{ 0x190C, "CY8C4024AZI-S403", "TQFP-48",  .flash_size_in_kb = 16 },
	{ 0x190D, "CY8C4024AZI-S413", "TQFP-48",  .flash_size_in_kb = 16 },
	{ 0x190E, "CY8C4025AZI-S403", "TQFP-48",  .flash_size_in_kb = 32 },
	{ 0x190F, "CY8C4025AZI-S413", "TQFP-48",  .flash_size_in_kb = 32 },
	{ 0x1910, "CY8C4024FNI-S402", "WLCSP-25", .flash_size_in_kb = 16 },
	{ 0x1911, "CY8C4024FNI-S412", "WLCSP-25", .flash_size_in_kb = 16 },
	{ 0x1912, "CY8C4025FNI-S402", "WLCSP-25", .flash_size_in_kb = 32 },
	{ 0x1913, "CY8C4025FNI-S412", "WLCSP-25", .flash_size_in_kb = 32 },
	...
	{ 0x041A, "CY8C4124AXI-443", "TQFP-48",   .flash_size_in_kb = 16 },
	{ 0x041B, "CY8C4125AXI-473", "TQFP-44",   .flash_size_in_kb = 32 },
	{ 0x041C, "CY8C4124LQI-443", "QFN-40",    .flash_size_in_kb = 16 },
	{ 0x0426, "CY8C4125AZI-483", "LQFP-48",   .flash_size_in_kb = 32 },
	{ 0x042A, "CY8C4124AZI-443", "LQFP-48",   .flash_size_in_kb = 16 },
	{ 0x042B, "CY8C4125AZI-473", "LQFP-48",   .flash_size_in_kb = 32 },
	{ 0x0464, "CY8C4124PVA-442", "SSOP-28",   .flash_size_in_kb = 16 },
	{ 0x0466, "CY8C4124PVS-442", "SSOP-28",   .flash_size_in_kb = 16 },
	{ 0x1B03, "CY8C4124LQI-S413", "QFN-40",   .flash_size_in_kb = 16 },
	{ 0x1B04, "CY8C4124LQI-S433", "QFN-40",   .flash_size_in_kb = 16 },
	{ 0x1B09, "CY8C4124LQI-S412", "QFN-32",   .flash_size_in_kb = 16 },
	{ 0x1B0A, "CY8C4124LQI-S432", "QFN-32",   .flash_size_in_kb = 16 },
	{ 0x1B10, "CY8C4124AZI-S413", "TQFP-48",  .flash_size_in_kb = 16 },
	{ 0x1B11, "CY8C4124AZI-S433", "TQFP-48",  .flash_size_in_kb = 16 },
	{ 0x1B16, "CY8C4124FNI-S403", "WLCSP-35", .flash_size_in_kb = 16 },
	{ 0x1B17, "CY8C4124FNI-S413", "WLCSP-35", .flash_size_in_kb = 16 },
	{ 0x1B18, "CY8C4124FNI-S433", "WLCSP-35", .flash_size_in_kb = 16 },

	/* 4100A series */
	{ 0x0460, "CY8C4244PVA-442", "SSOP-28",   .flash_size_in_kb = 16 },
	{ 0x0461, "CY8C4245PVA-482", "SSOP-28",   .flash_size_in_kb = 32 },
	{ 0x0465, "CY8C4125PVA-482", "SSOP-28",   .flash_size_in_kb = 32 },
	{ 0x0467, "CY8C4125PVS-482", "SSOP-28",   .flash_size_in_kb = 32 },

	/* 4200 series */
	{ 0x0462, "CY8C4244PVS-442", "SSOP-28",   .flash_size_in_kb = 16 },
	{ 0x0463, "CY8C4245PVS-482", "SSOP-28",   .flash_size_in_kb = 32 },
	...
	{ 0x04D8, "CY8C4245AZI-483", "TQFP-48",   .flash_size_in_kb = 32 },
	{ 0x04DA, "CY8C4244AZI-443", "TQFP-44",   .flash_size_in_kb = 16 },
	{ 0x04DB, "CY8C4245AZI-473", "TQFP-48",   .flash_size_in_kb = 32 },
	...
	/* 4200L series */
	{ 0x1000, "CY8C4246AZI-L433", "TQFP-48",  .flash_size_in_kb = 64 },
	{ 0x1001, "CY8C4246AZI-L435", "TQFP-64",  .flash_size_in_kb = 64 },
	{ 0x1002, "CY8C4246AZI-L423", "TQFP-48",  .flash_size_in_kb = 64 },
	{ 0x1003, "CY8C4246AZI-L445", "TQFP-64",  .flash_size_in_kb = 64 },
	{ 0x1004, "CY8C4246LTI-L445", "QFN-68",   .flash_size_in_kb = 64 },
	{ 0x1005, "CY8C4247AZI-L423", "TQFP-48",  .flash_size_in_kb = 128 },
	{ 0x1006, "CY8C4247AZI-L445", "TQFP-64",  .flash_size_in_kb = 128 },
	{ 0x1007, "CY8C4247LTI-L445", "QFN-68",   .flash_size_in_kb = 128 },
	{ 0x1008, "CY8C4247AZI-L475", "TQFP-64",  .flash_size_in_kb = 128 },
	{ 0x1009, "CY8C4247LTI-L475", "QFN-68",   .flash_size_in_kb = 128 },
	{ 0x100A, "CY8C4247BZI-L479", "BGA-124",  .flash_size_in_kb = 128 },
	{ 0x100B, "CY8C4247AZI-L485", "TQFP-68",  .flash_size_in_kb = 128 },
	{ 0x100C, "CY8C4247LTI-L485", "QFN-68",   .flash_size_in_kb = 128 },
	{ 0x100D, "CY8C4247BZI-L489", "BGA-124",  .flash_size_in_kb = 128 },
	{ 0x100E, "CY8C4248AZI-L475", "TQFP-64",  .flash_size_in_kb = 256 },
	{ 0x100F, "CY8C4248LTI-L475", "QFN-68",   .flash_size_in_kb = 256 },
	{ 0x1010, "CY8C4248BZI-L479", "BGA-124",  .flash_size_in_kb = 256 },
	{ 0x1011, "CY8C4248AZI-L485", "TQFP-64",  .flash_size_in_kb = 256 },
	{ 0x1012, "CY8C4248LTI-L485", "QFN-68",   .flash_size_in_kb = 256 },
	{ 0x1013, "CY8C4248BZI-L489", "BGA-124",  .flash_size_in_kb = 256 },
	{ 0x1015, "CY8C4247AZI-L433", "TQFP-48",  .flash_size_in_kb = 128 },

	/* 4200M series */
	{ 0x1121, "CY8C4245AZI-M443", "TQFP-48",  .flash_size_in_kb = 32 },
	{ 0x1122, "CY8C4245AZI-M445", "TQFP-64",  .flash_size_in_kb = 32 },
	{ 0x1123, "CY8C4245LTI-M445", "QFN-68",   .flash_size_in_kb = 32 },
	{ 0x1124, "CY8C4245AXI-M445", "TQFP-64",  .flash_size_in_kb = 32 },
	{ 0x1125, "CY8C4246AZI-M443", "TQFP-48",  .flash_size_in_kb = 64 },
	{ 0x1126, "CY8C4246AZI-M445", "TQFP-64",  .flash_size_in_kb = 64 },
	{ 0x1127, "CY8C4246AZI-M475", "TQFP-64",  .flash_size_in_kb = 64 },
	{ 0x1128, "CY8C4246LTI-M445", "QFN-68",   .flash_size_in_kb = 64 },
	{ 0x1129, "CY8C4246LTI-M475", "QFN-68",   .flash_size_in_kb = 64 },
	{ 0x112A, "CY8C4246AXI-M445", "TQFP-64",  .flash_size_in_kb = 64 },
	{ 0x112B, "CY8C4247LTI-M475", "QFN-64",   .flash_size_in_kb = 128 },
	{ 0x112C, "CY8C4247AZI-M475", "TQFP-64",  .flash_size_in_kb = 128 },
	{ 0x112D, "CY8C4247AZI-M485", "TQFP-64",  .flash_size_in_kb = 128 },
	{ 0x112E, "CY8C4247AXI-M485", "TQFP-64",  .flash_size_in_kb = 128 },
	{ 0x112F, "CY8C4245LTI-DM405", "QFN-68",  .flash_size_in_kb = 32 },
	{ 0x1130, "CY8C4246LTI-DM405", "QFN-68",  .flash_size_in_kb = 64 },
	{ 0x1163, "CY8C4247LTQ-M475", "QFN-68",   .flash_size_in_kb = 128 },
