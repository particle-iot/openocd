		...
		uint32_t offset, uint32_t count)
{
	...
	static const uint8_t stm32l4_flash_write_code[] = {
		0xd0, 0xf8, 0x00, 0x80, 0xb8, 0xf1, 0x00, 0x0f, 0x1e, 0xd0, 0x47, 0x68,
		0xb8, 0xeb, 0x07, 0x06, 0x07, 0x2e, 0xf5, 0xd3, 0xdf, 0xf8, 0x34, 0x60,
		0x66, 0x61, 0xf7, 0xe8, 0x02, 0x89, 0xe2, 0xe8, 0x02, 0x89, 0xbf, 0xf3,
		0x4f, 0x8f, 0x26, 0x69, 0x16, 0xf4, 0x80, 0x3f, 0xfb, 0xd1, 0x16, 0xf0,
		0xfa, 0x0f, 0x07, 0xd1, 0x8f, 0x42, 0x28, 0xbf, 0x00, 0xf1, 0x08, 0x07,
		0x47, 0x60, 0x01, 0x3b, 0x13, 0xb1, 0xdd, 0xe7, 0x00, 0x21, 0x41, 0x60,
	...
	/* target_run_flash_async_algorithm() takes number of
	 * half words (16-bit) as argument (count).
	 * flash write stub needs double words (64-bit) as argument.
	 */

	init_reg_param(&reg_params[0], "r0", 32, PARAM_IN_OUT);	/* buffer start, status (out) */
	init_reg_param(&reg_params[1], "r1", 32, PARAM_OUT);	/* buffer end */
	init_reg_param(&reg_params[2], "r2", 32, PARAM_OUT);	/* target address */
	init_reg_param(&reg_params[3], "r3", 32, PARAM_OUT);	/* number of double words (64bit) */
...
static int stm32l4_probe(struct flash_bank *bank)
{
	...
	/* Early silicon revisions may have garbage in bit 12..15*/
