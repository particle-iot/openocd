...
/**
 * Copy is_protection flags from protection blocks array to sector array.
 * @param bank The bank to process.
 * @returns ERROR_OK on success, or an error indicating the problem.
 *
 * Function assumes protection block size same or bigger than sector size
 * If protection block has boundaries outsize sector boundaries
 * a sector inherits protection flag from lowest intersecting protection block.
 */
