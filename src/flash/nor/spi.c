...
const struct flash_device flash_devices[] = {
	...
	FLASH_ID("eon en25f32",    0xd8, 0xc7, 0x0016311c, 0x100, 0x10000, 0x400000),
	FLASH_ID("eon en25p32",    0xd8, 0xC7, 0x0016201c, 0x100, 0x10000, 0x400000),
	FLASH_ID("eon en25q32b",   0xd8, 0xC7, 0x0016301c, 0x100, 0x10000, 0x400000),
	FLASH_ID("eon en25p64",    0xd8, 0xC7, 0x0017201c, 0x100, 0x10000, 0x800000),
	FLASH_ID("eon en25q64",    0xd8, 0xC7, 0x0017301c, 0x100, 0x10000, 0x800000),
