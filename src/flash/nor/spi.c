...
const struct flash_device flash_devices[] = {
	...
	FLASH_ID("win w25q32dw",        0x03, 0xeb, 0x02, 0x20, 0xc7, 0x006016ef, 0x100, 0x1000,  0x400000),
	FLASH_ID("win w25q32jw",        0x03, 0xeb, 0x02, 0x20, 0xc7, 0x008016ef, 0x100, 0x1000,  0x400000),
