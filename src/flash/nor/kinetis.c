...
static int kinetis_ftfx_command(struct flash_bank *bank, uint8_t fcmd, uint32_t faddr,
				uint8_t databyte0, uint8_t databyte1, uint8_t databyte2, uint8_t databyte3,
				uint8_t databyte4, uint8_t databyte5, uint8_t databyte6, uint8_t databyte7,
				uint8_t *ftfx_fstat)
{
	uint8_t command[12] = {faddr & 0xff, (faddr >> 8) & 0xff, (faddr >> 16) & 0xff, fcmd,
			      databyte3, databyte2, databyte1, databyte0,
