						   ...
						   uint32_t offset, uint32_t count)
{
	...
	/* We need to enable it before programming the flash such that when ECC
	   ...
	   Note that according to the ADuCM302x Hardware Reference Manual, "If
	   ...
	   else ECC errors are reported". The following code assumes for all the
	   DWORDs it writes to this is the first write since they were erased. */
