...
/* The following is only MinGW (i.e. not MinGW-w64  */
#ifndef __MINGW64__
 ...
 * So junk the definitions.
 */
#define fprintf(...)   junk_fprintf(__VA_ARGS__)
#define printf(...)    junk_printf(__VA_ARGS__)
#define sprintf(...)   junk_sprintf(__VA_ARGS__)
#define snprintf(...)  junk_snprintf(__VA_ARGS__)
