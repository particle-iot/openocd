...
/* The following is only for standard MinGW (i.e. not MinGW-w64 32-bit) */
 ...
 */
#define fprintf   junk_fprintf
#define printf    junk_printf
#define sprintf   junk_sprintf
#define snprintf  junk_snprintf
