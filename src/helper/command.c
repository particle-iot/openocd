...
DEFINE_PARSE_LONGLONG(_int, int, 0, INT_MAX)
DEFINE_PARSE_LONGLONG(_s64, int64_t, 0, INT64_MAX)
DEFINE_PARSE_LONGLONG(_s32, int32_t, 0, INT32_MAX)
DEFINE_PARSE_LONGLONG(_s16, int16_t, 0, INT16_MAX)
DEFINE_PARSE_LONGLONG(_s8, int8_t, 0, INT8_MAX)
