...
DEFINE_PARSE_LONGLONG(_int, int, 0, UINT_MAX)
DEFINE_PARSE_LONGLONG(_s64, int64_t, 0, UINT64_MAX)
DEFINE_PARSE_LONGLONG(_s32, int32_t, 0, UINT32_MAX)
DEFINE_PARSE_LONGLONG(_s16, int16_t, 0, UINT16_MAX)
DEFINE_PARSE_LONGLONG(_s8, int8_t, 0, UINT8_MAX)
