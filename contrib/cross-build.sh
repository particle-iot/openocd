...
$LIBUSB1_SRC/configure --enable-maintainer-mode --host=$HOST_TRIPLET --with-sysroot=$SYSROOT --prefix=$PREFIX \
$LIBUSB1_CONFIG
make
...
$OPENOCD_SRC/configure --enable-maintainer-mode --host=$HOST_TRIPLET --with-sysroot=$SYSROOT --prefix=$PREFIX \
$OPENOCD_CONFIG
make
make install DESTDIR=$SYSROOT
